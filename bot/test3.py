...
from telegram import Chat, ChatMember, ChatMemberUpdated, ReplyKeyboardMarkup, ReplyKeyboardRemove, Update
...
persistence = MongoPersistence(
    ...
    name_col_conversations_data="conversations-data",  # optional
